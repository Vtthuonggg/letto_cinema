  ...
  <div class="menu" v-if="isMenuOpen">
    ...
    <ul>
      <li>
        <button
          class="icon-button"
          :class="{ 'active-link': isActive('/film') }"
          style="justify-content: left; white-space: nowrap"
          @click="handleEvent('film')"
        >
      ...
      <hr
        class="dash-lined"
        style="margin-top: 20px; margin-bottom: 20px; color: grey"
      />

      <li>
        <button
          class="icon-button"
          :class="{ 'active-link': isActive('/ticket') }"
          style="justify-content: left; white-space: nowrap"
          @click="handleEvent('ticket')"
        >
      ...
      <li>
        <button
          class="icon-button"
          :class="{ 'active-link': isActive('/infor-ticket') }"
          style="justify-content: left; white-space: nowrap"
          @click="handleEvent('infor-ticket')"
        >
      ...
      <li class="nav-logout">
        <button
          class="icon-button"
          style="color: red; justify-content: left; white-space: nowrap"
