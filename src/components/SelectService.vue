        ...
        <div class="pop-container">
            ...
            <div class="content">
                <v-container v-if="listService.length > 0">
                    <v-row>
                        <v-col v-for="(item, index) in listService" :key="index" cols="12" sm="6" md="6" lg="6">
            ...
            <div class="detail-container">
                <div class="detail-content">
                    ...
                    <div class="quantity-container">
                        ...
                        <v-text-field v-model="selectedService.quantity" min="1" class="quantity-input"
                            @keydown="isNumber"></v-text-field>
                ...
                <div class="detail-footer">
                    <v-btn class="gradient-button-cancel" @click="closeDetailPopup">Hủy</v-btn>
                    <v-btn class="gradient-button-confirm" color="primary" @click="confirmDetail">Xác nhận</v-btn>
                </div>
            </div>
        </div>
    </div>
...
import { addBillService } from "@/components/api/bill_api.js";
